...
Pattern::Pattern(PatternType type) {
    ...
    if( type == PatternType::sigmod2020_guo_q1) {
        size = 4;
        adj_mat = new int[size * size];
        memset(adj_mat, 0, size * size * sizeof(int));
        add_edge(0, 1);
    ...
    if( type == PatternType::sigmod2020_guo_q2) {
        size = 4;
        adj_mat = new int[size * size];
        memset(adj_mat, 0, size * size * sizeof(int));
        add_edge(0, 1);
    ...
    if( type == PatternType::sigmod2020_guo_q3) {
        size = 4;
        adj_mat = new int[size * size];
        memset(adj_mat, 0, size * size * sizeof(int));
        add_edge(0, 1);
    ...
    if( type == PatternType::sigmod2020_guo_q4) {
        size = 5;
        adj_mat = new int[size * size];
        memset(adj_mat, 0, size * size * sizeof(int));
        add_edge(0, 1);
    ...
    if( type == PatternType::sigmod2020_guo_q5) {
        size = 5;
        adj_mat = new int[size * size];
        memset(adj_mat, 0, size * size * sizeof(int));
        add_edge(0, 1);
    ...
    if( type == PatternType::sigmod2020_guo_q6) {
        size = 5;
        adj_mat = new int[size * size];
        memset(adj_mat, 0, size * size * sizeof(int));
        for(int i = 0; i < size; ++i)
