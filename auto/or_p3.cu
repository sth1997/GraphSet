...
unsigned long long do_pattern_matching(Graph* g,
    ...
    cudaOccupancyMaxActiveBlocksPerMultiprocessor(&max_active_blocks_per_sm,
        pattern_matching_kernel, THREADS_PER_BLOCK, 608);
    ...
    size_t size_tmp = VertexSet::max_intersection_size * sizeof(uint32_t) * nr_total_warps * 3;
    ...
    pattern_matching_kernel<<<nr_blocks, THREADS_PER_BLOCK, 608>>>
