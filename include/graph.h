...
*/
    ...
    long long pattern_matching(const Schedule& schedule, int thread_count, bool clique = false, bool clique_optimization = false);
...
private:
    ...
    virtual void get_edge_index(int v, unsigned int& l, unsigned int& r) const;
    ...
    void pattern_matching_aggressive_func(const Schedule& schedule, VertexSet* vertex_set, VertexSet& subtraction_set, VertexSet& tmp_set, long long& local_ans, int depth, bool is_clique_optimzition = false);
