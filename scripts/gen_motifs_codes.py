...
for g_idx, graph in enumerate(graphs):
    for p in range(len(patterns)):
        ...
        log_name = "./auto/" + g[g_idx] + "_motif_test" + str(p + 1) + "_inject.cu" 
        os.system("./build/bin/final_generator /home/zms/GraphMining/graph_dataset/" + graph + " " + str(patterns[p]) + " > " + log_name)
